...
const testNFTAddr = (
  process.env.ELEMENT_TEST_ERC721_ADDRESS ?? "0x0000000000000000000000000000000000000000"
).toLowerCase();
const erc1155NFT = (
  process.env.ELEMENT_TEST_ERC1155_ADDRESS ?? "0x0000000000000000000000000000000000000000"
).toLowerCase();
