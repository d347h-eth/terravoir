...
import * as portfolioEndpoints from "@/api/endpoints/portfolio";
...
export const setupRoutes = (server: Server) => {
  ...
  server.route({
    method: "GET",
    path: "/portfolio/activity/v1",
    options: activitiesEndpoints.getPortfolioActivityV1Options,
  });
  ...
  server.route({
    method: "POST",
    path: "/admin/resync-rate-limit-rule",
    options: adminEndpoints.postResyncRateLimitRule,
  });
  ...
  server.route({
    method: "POST",
    path: "/admin/create-source",
    options: adminEndpoints.postCreateSourceOptions,
  });
  ...
  server.route({
    method: "POST",
    path: "/admin/calc-usd-price",
    options: adminEndpoints.postCalcUsdPriceOptions,
  });
  ...
  server.route({
    method: "GET",
    path: "/collections/{collection}/attributes/explore/v6",
    options: attributesEndpoints.getAttributesExploreV6Options,
  });
  ...
  server.route({
    method: "POST",
    path: "/collections/{collection}/override/v2",
    options: collectionsEndpoints.postCollectionsOverrideV2Options,
  });
  ...
  server.route({
    method: "GET",
    path: "/collections/trending-mints/v2",
    options: collectionsEndpoints.getTrendingMintsV2Options,
  });
  ...
  server.route({
    method: "POST",
    path: "/execute/solve/capacity/v2",
    options: executeEndpoints.postExecuteSolveCapacityV2Options,
  });
  ...
  server.route({
    method: "GET",
    path: "/portfolio/historical/value/v1",
    options: portfolioEndpoints.getHistoricalPortfolioValueV1Options,
  });

  server.route({
    method: "GET",
    path: "/portfolio/tokens/balance/v1",
    options: portfolioEndpoints.getTokensBalanceV1Options,
  });

  server.route({
    method: "GET",
    path: "/portfolio/value/v1",
    options: portfolioEndpoints.getPortfolioValueV1Options,
  });

  server.route({
    method: "GET",
    path: "/portfolio/nfts/balance/v1",
    options: portfolioEndpoints.getNftsBalanceV1Options,
  });
  ...
  server.route({
    method: "POST",
    path: "/tokens/{token}/override/v1",
    options: tokensEndpoints.postTokensOverrideV1Options,
  });
  ...
  server.route({
    method: "GET",
    path: "/tokens/prices/v1",
    options: tokensEndpoints.getTokensPricesV1Options,
  });
  ...
  server.route({
    method: "GET",
    path: "/fungibles/v1",
    options: tokensEndpoints.getFungibleTokensV1Options,
  });

  server.route({
    method: "GET",
    path: "/tokenlist/v1",
    options: tokensEndpoints.getFungibleTokenListV1Options,
  });

  server.route({
    method: "GET",
    path: "/search/tokens/v1",
    options: tokensEndpoints.getSearchFungibleTokensV1Options,
  });
  ...
  server.route({
    method: "GET",
    path: "/tokens/transfers/v1",
    options: currenciesEndpoints.getTransfersV1Options,
  });
